...
async function Questions() {
    ...
    const sql_response = await Anime.Create.Anime(animename, language, season, episodes, rating_grafik, rating_story, rating_values, rating_character, watch_start, watch_end);
